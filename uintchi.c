/* uintchi.c - UINT chi square test Version 0.1.0                    */
...
int main(void)
   ...
   while (i--)
      {
      int indx;
      indx = (rucrc(ru) >> 28) & 15;      /* 4 bit sample 0-15 */
   ...
   while (i--)
      {
      int indx;
      indx = (rucrc(ru) >> 24) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (rucrc(ru) >> 20) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (rucrc(ru) >> 16) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (rucrc(ru) >> 12) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (rucrc(ru) >> 8) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (rucrc(ru) >> 4) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = rucrc(ru) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
