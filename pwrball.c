/* pwrball.c - Powerball lottery simulator  Version 0.1.0            */
...
int main()
   ...
   char maindraw[128];
   char bonuspool[64];
   ru = (rufmt *) rucrcinit();   /* initialize rucrc generator */
   ...
   *p = 1;
   ...
   free(ru->state);    /* free state array */
